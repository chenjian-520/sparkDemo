...
LEFT JOIN dpm_ods_manual_manhour manhour on
  concat(year(from_unixtime(to_unix_timestamp(manhour.Date, 'yyyyMMdd'), 'yyyy-MM-dd')),weekofyear(from_unixtime(to_unix_timestamp(manhour.Date, 'yyyyMMdd'), 'yyyy-MM-dd')))
  =
  concat(year(from_unixtime(to_unix_timestamp(output.WorkDT, 'yyyyMMdd'), 'yyyy-MM-dd')),weekofyear(from_unixtime(to_unix_timestamp(output.WorkDT, 'yyyyMMdd'), 'yyyy-MM-dd')))
