...
FROM
  ...
  (
    SELECT
      cast(concat(year(from_unixtime(to_unix_timestamp(L5_6_10.WorkDate, 'yyyyMMdd'), 'yyyy-MM-dd')),
                  weekofyear(from_unixtime(to_unix_timestamp(L5_6_10.WorkDate, 'yyyyMMdd'), 'yyyy-MM-dd'))) AS
           INTEGER)                                                                           week_id,
      L5_6_10.Site_Code,
      L5_6_10.Level_Code,
      sum(L5_6_10.QTY)                                                                        QTY,
