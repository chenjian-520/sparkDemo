SELECT
  ...
  nvl(if(L5_6_10.Level_Code = 'L5', (L5_6_10.QTY + dpm_ods_manual_manhour.Output), L5_6_10.QTY), 0)  online_dl_output_actual,
  nvl(if(L5_6_10.Level_Code = 'L5', (L5_6_10.QTY + dpm_ods_manual_manhour.Output), L5_6_10.QTY), 0) offline_var_dl_output_actual,
  nvl(ehr_man_hour.DL2F, 0) offline_fix_dl_headcount_actual,
  0                                                                site_code_id,
  0                                                                level_code_id,
  ''                                                               site_code_desc,
  ''                                                               level_code_desc,
