...
@AllArgsConstructor
@NoArgsConstructor
@HBaseTable(level = "ods", table = "dpm_ods_production_output_day_lsix", family = "DPM_ODS_PRODUCTION_OUTPUT_DAY_LSIX_BAK")
public class ODSProductionOutputDayLsix implements Serializable {
