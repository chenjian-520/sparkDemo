...
public class DWSProductionLineDowntimeHH extends HBaseBean {
    ...
    public String getBaseRowKey() {
        ...
        return KeyUtil.buildKey(Long.toString(workDtMills), getSiteCode(), getLevelCode(), getAreaCode()
                , getLineCode(), getPreSn(), getLossDt(), getStartTimeSeq()
                , getLossStartTime());
    }
     ...
     * @author ws
     * @date 2020/7/6 17:08
     * @return com.foxconn.dpm.sprint5.dws_ads.bean.AdsProductionDowntimeDay
     **/
    public AdsProductionDowntimeDay convert2AdsProductionDowntimeDay() {
        AdsProductionDowntimeDay downtimeDay = new AdsProductionDowntimeDay();
        BeanUtil.copyProperties(this, downtimeDay);

        downtimeDay.setId(getPreSn() + getLossStartTime() + getLossDt() + getStartTimeSeq())
                .setWorkDate(this.getWorkDt())
                .setDowntimeActual(Integer.parseInt(this.getDownTime()))
                .setEtlTime(DateUtil.now())
                .setSectionId(this.getStartTimeSeq())
                .setSectionDesc(this.getStartTime() + "-" + this.getEndTime());
        return downtimeDay;
    }
