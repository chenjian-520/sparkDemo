...
@AllArgsConstructor
@NoArgsConstructor
@HBaseTable(level = "ods", table = "dpm_ods_production_output_day_lten", family = "DPM_ODS_PRODUCTION_OUTPUT_DAY_LTEN_BAK")
public class ODSProductionOutputDayLtem implements Serializable {
