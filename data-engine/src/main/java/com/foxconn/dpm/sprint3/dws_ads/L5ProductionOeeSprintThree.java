 ...
 */
public class L5ProductionOeeSprintThree extends DPSparkBase {
    ...
    public void scheduling(Map<String, Object> map) throws Exception {
        ...
        System.out.println("==============================>>>oee2Targets End<<<==============================");
        //日OEE
    ...
    public void calculateDayProductionOee(JavaPairRDD<String, DpmDwsProductionOeeEquipmentLineDD> dwsProductionOeeEquipmentLineDDJavaPairRDD) throws Exception {
        ...
        JavaRDD<DpmAdsProductionOeeDay> calculatedOee = dwsProductionOeeEquipmentLineDDJavaPairRDD.reduceByKey((kv1, kv2) -> {
            ...
            Float oee2Target = oee2Targets.get(org[2] + "," + org[3] + "," + org[4]);
            float oee1_actual = 0f;
            try {
                oee1_actual = (good_product_qty / actual_output_qty) * (operation_time / total_work_time) * (output_hours / operation_time) * 100;
            } catch (Exception e) {
                oee1_actual = 0f;
            }
            float oee2_actual = 0f;
            try {
                oee2_actual = (loading_time / loading_time -
                        (
    ...
    public void calculateWeekProductionOee(JavaPairRDD<String, DpmDwsProductionOeeEquipmentLineDD> dwsProductionOeeEquipmentLineDDJavaPairRDD) throws Exception {
        ...
        DPMysql.commonOdbcWriteBatch("dp_ads","dpm_ads_production_oee_week", calculatedOee, MetaGetter.getBeanGetter().creDeftSchemaMap("dpm_ads_production_oee_week"), MetaGetter.getBeanGetter().getDeftSchemaStruct("dpm_ads_production_oee_week"));
    }
    ...
    public void calculateMonthProductionOee(JavaPairRDD<String, DpmDwsProductionOeeEquipmentLineDD> dwsProductionOeeEquipmentLineDDJavaPairRDD) throws Exception {
        ...
        System.out.println("==============================>>>calculatedOee End<<<==============================");
        DPMysql.commonOdbcWriteBatch("dp_ads","dpm_ads_production_oee_month", calculatedOee, MetaGetter.getBeanGetter().creDeftSchemaMap("dpm_ads_production_oee_month"), MetaGetter.getBeanGetter().getDeftSchemaStruct("dpm_ads_production_oee_month"));
    }
    ...
    public void calculateQuarterProductionOee(JavaPairRDD<String, DpmDwsProductionOeeEquipmentLineDD> dwsProductionOeeEquipmentLineDDJavaPairRDD) throws Exception {
        ...
        System.out.println("==============================>>>calculatedOee End<<<==============================");
        DPMysql.commonOdbcWriteBatch("dp_ads","dpm_ads_production_oee_quarter", calculatedOee, MetaGetter.getBeanGetter().creDeftSchemaMap("dpm_ads_production_oee_quarter"), MetaGetter.getBeanGetter().getDeftSchemaStruct("dpm_ads_production_oee_quarter"));
    }
    ...
    public void calculateYearProductionOee(JavaPairRDD<String, DpmDwsProductionOeeEquipmentLineDD> dwsProductionOeeEquipmentLineDDJavaPairRDD) throws Exception {
        ...
        System.out.println("==============================>>>calculatedOee End<<<==============================");
        DPMysql.commonOdbcWriteBatch("dp_ads","dpm_ads_production_oee_year", calculatedOee, MetaGetter.getBeanGetter().creDeftSchemaMap("dpm_ads_production_oee_year"), MetaGetter.getBeanGetter().getDeftSchemaStruct("dpm_ads_production_oee_year"));
    }
