...
public class ManualHour {
    ...
    public ManualHour(String date, String group, String site, String level, String BU, String factory, String line, Double DL1_TTL_Manhour, Double DL2_Fixed_Manhour, Double DL2_Variable_Manhour, Double offline_DL_fixed_headcount) {
        Date = date;
        Group = group;
        Site = site;
        Level = level;
        ...
        this.DL2_Fixed_Manhour = DL2_Fixed_Manhour;
    ...
    public Double getDL2_Fixed_Manhour() {
        return DL2_Fixed_Manhour;
    }

    public void setDL2_Fixed_Manhour(Double DL2_Fixed_Manhour) {
        this.DL2_Fixed_Manhour = DL2_Fixed_Manhour;
    }
    ...
    public String toString() {
        return "ManualHour{" +
                ...
                ", DL2_Fixed_Manhour=" + DL2_Fixed_Manhour +
