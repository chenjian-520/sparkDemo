 ...
 */
public class L10ProductionOTDSprintFour extends DPSparkBase {
    ...
    public void calculateL10DayProductionOTD() throws Exception {
        Dataset<Row> resultRows = sqlContext.sql(
                "SELECT" +
                        ...
                        "  get_aim_target_by_key(concat_ws('=', 'D', site_code, level_code, 'all', 'Shipping', 'all', 'all', customer), 13) * 100  otd_target, " +
