...
) where week_id = calculateYearWeek(from_unixtime((unix_timestamp()-(60*60*24)), 'yyyy-MM-dd')) or week_id = calculateYearWeek(from_unixtime((unix_timestamp()-(60*60*24*8)), 'yyyy-MM-dd'))
