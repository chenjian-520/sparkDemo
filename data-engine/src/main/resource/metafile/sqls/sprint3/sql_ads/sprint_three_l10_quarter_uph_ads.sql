      ...
      (
        ...
        FROM
          ...
          (
            ...
            GROUP BY site_code, level_code, line_code, customer,cast(concat(year(work_dt), quarter(work_dt)) AS INTEGER),area_code
        ...
        GROUP BY
          t1.site_code, t1.level_code, t1.quarter_id, t1.customer, t1.process_code
      ) t
    UNION ALL
    SELECT
      site_code,
