SELECT
  ...
  dpm_ods_production_planning_day_sc.quarter_id                            quarter_id,
...
FROM
  ...
  LEFT JOIN (
    ...
    ON
      dpm_ods_production_planning_day_sc.quarter_id = dpm_dws_production_output_dd_mthine.quarter_id AND
