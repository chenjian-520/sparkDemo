...
FROM (
     ...
     FROM
          (SELECT
           ...
           GROUP BY t3.site_code , t3.level_code , t3.year_id , t3.customer , t3.station_code ,t3.input_qty ,t3.ng_qty) t4
     GROUP BY t4.site_code , t4.level_code , t4.year_id , t4.customer
    ) t5 GROUP BY t5.site_code , t5.level_code , t5.year_id
