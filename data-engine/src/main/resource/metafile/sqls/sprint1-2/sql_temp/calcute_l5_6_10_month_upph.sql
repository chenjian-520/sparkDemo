...
FROM
  ...
  LEFT JOIN (
              ...
              SELECT
                ...
                cast(sum(dpm_ods_manual_manhour.Output)  AS FLOAT)                                        Output,
  ...
  LEFT JOIN (
    ...
    ON ehr_man_hour_last_day_headcount.month_id = L5_6_10.month_id AND ehr_man_hour_last_day_headcount.r = 1
    ...
    LEFT JOIN (SELECT
                 from_unixtime(to_unix_timestamp(day_oee_fpy.work_date, 'yyyyMMdd'), 'yyyyMM') month_id,
               ...
               FROM day_oee_fpy
               GROUP BY
                 from_unixtime(to_unix_timestamp(day_oee_fpy.work_date, 'yyyyMMdd'), 'yyyyMM'),
                 day_oee_fpy.site_code,
                 day_oee_fpy.level_code

              ) day_oee_fpy ON
                              day_oee_fpy.month_id = L5_6_10.month_id
                              AND
                              day_oee_fpy.site_code
                              =
                              L5_6_10.Site_Code
